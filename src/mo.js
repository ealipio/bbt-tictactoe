...
const whirl = new mojs.Shape({
 ...
 //+++++++++++++++++++++++++++++++++++++++++
const basicShape = new mojs.Shape({
    shape: "rect",
    isShowStart: true,
    radius:50,
    fill: "#c9cbfd",
...
const secondaryShape = new mojs.Shape({
    shape:"circle",
    isShowStart: true,
    radius: 50,
    top: "50%",
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++
const timeline = new mojs.Timeline({repeat:2, isYoyo:true});
...
export default document.addEventListener(clickHandler, function (e) {
